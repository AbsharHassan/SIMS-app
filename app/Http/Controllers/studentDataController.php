    ...
    public function store(Request $request) 
    {
        if(!studentData::find($request->id)) {
            $formFields = $request->validate([
                ...
                'gender' => 'nullable',
                'fsc_marks' => ['nullable', 'numeric', 'lte:1100'],
                'fsc_year' => ['nullable'],
                'fsc_div' => ['nullable', 'gte:1', 'lte:3'],
                'matric_marks' => ['nullable', 'numeric', 'lte:1100'],
                'matric_year' => ['nullable'],
                'matric_div' => ['nullable', 'gte:1', 'lte:3'],
                'current_sem' => ['nullable', 'numeric', 'gte:1','lte:8'],
                'department' => 'nullable',
                'degree' => ['nullable', 'numeric', 'gte:40', 'lte:44'],
                'syn' => 'nullable',
                'reason' => 'nullable',
                'img' => 'nullable'
            ]);
